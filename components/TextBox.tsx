...
export const TextBox = (prop: Prop): JSX.Element => {
  const { type = 'info', label, description } = prop;
  if (type === 'warning') {
    return (
  ...
  return (
    <div className="alert flex flex-row items-center rounded border-b-2 bg-blue-200 p-5 border-blue-300">
      <div className="alert-icon flex items-center border-2 justify-center h-10 w-10 flex-shrink-0 rounded-full bg-blue-100 border-blue-500">
